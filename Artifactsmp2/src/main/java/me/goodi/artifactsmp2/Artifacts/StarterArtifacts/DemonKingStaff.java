...
import me.goodi.artifactsmp2.GUI.DemonKingStaffUPG;
...
public class DemonKingStaff implements Listener {
    ...
    public void DropItem(PlayerDropItemEvent e) {
        ...
        if (item.hasItemMeta() && item.getItemMeta().hasCustomModelData() && item.getItemMeta().getCustomModelData() == CustomModelDataNum.DemonKingsStaff) {
    ...
    public void dropOnDeath(PlayerDeathEvent e) {
        for (ItemStack item : e.getPlayer().getInventory()) {
            if (item != null && item.hasItemMeta() && item.getItemMeta().hasCustomModelData() && item.getItemMeta().getCustomModelData() == CustomModelDataNum.DemonKingsStaff) {
                RG = item;
    ...
    public void upgrade(PlayerInteractEvent e) {
        ...
        if (player.getInventory().getItemInMainHand().hasItemMeta() && player.getInventory().getItemInMainHand().getItemMeta().hasCustomModelData() && player.getInventory().getItemInMainHand().getItemMeta().getCustomModelData() == CustomModelDataNum.DemonKingsStaff && e.getAction().equals(Action.RIGHT_CLICK_AIR)) {
            if (player.isSneaking()) {
                DemonKingStaffUPG.OpenDemonKingStaffUPG(player);
            }
        }
    }
    ...
    public void upg(InventoryClickEvent e) {
        if (e.getCurrentItem() != null && e.getCurrentItem().hasItemMeta() && e.getCurrentItem().getItemMeta().hasCustomModelData() && e.getCurrentItem().getItemMeta().getCustomModelData() == CustomModelDataNum.DemonKingsStaff) {
    ...
    public void Ability(PlayerInteractEvent e) {
        ...
        if (item1.hasItemMeta() && item1.getItemMeta().hasCustomModelData() && item1.getItemMeta().getCustomModelData() == CustomModelDataNum.DemonKingsStaff && e.getAction().isRightClick()) {
